...
import acriesgosImage from "@/app/assets/images/acriesgos.png";
...
export const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-color-white p-6">
      <div className="flex flex-col items-center bg-color-gray-light rounded-lg shadow-md max-w-md w-full p-8">
        <Image
          src={acriesgosImage}
          alt="Login"
          width={150}
          height={150}
          className="mb-6 rounded-lg border-2 border-color-orange"
        />
        <h2 className="text-color-gray-dark text-center font-bold text-xl mb-6">
          Bienvenido
        </h2>
